...
function [model,controller]=Reaction_Curve(t,y,u)
%for dynamicmodel code usi this reaction curve function
...
% figure(1);plot(t,y,[t0+time_delay t0+time_delay+time_constant],[y(1) y(end)],...
%     [t(1) t(end)],[y(1) y(1)],'--',[t(1) t(end)],[y(end) y(end)],'--');hold on;
% title('output')
% %subplot(212)
% figure(2);
% if isscalar(u)
%     
%     plot([t0 t(end)],[u u]);hold on;
% else
%    
%     plot(t,u);hold on;
% end
